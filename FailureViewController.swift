...
class FailureViewController: UIViewController {
    ...
    let imageViewIcon: UIImageView = {
        let imageViewIcon = UIImageView(image: UIImage(named: "error-outline"))
        imageViewIcon.tintColor = .red
    ...
    private func setupUI() {
        ...
        self.labelTitle.text = "Não foi possível\nconcluir a verificação"
        ...
        self.labelSubtitle.text = "Por favor, tente tirar a sua foto novamente."
        ...
        self.buttonMain.widthAnchor.constraint(equalToConstant: 200.0).isActive = true
        self.buttonMain.setTitle("TENTAR NOVAMENTE", for: .normal)
    }
    ...
    @objc private func actionMain() {
        self.delegate?.failureViewControllerMainAction()
    }
}
